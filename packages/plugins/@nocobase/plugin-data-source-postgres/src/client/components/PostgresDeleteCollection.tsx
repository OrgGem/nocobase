...
/**
 * Custom DeleteCollection component for PostgreSQL data source plugin.
...
export const PostgresDeleteCollection = (props: any) => {
  const record = useRecord();
  return <PostgresDeleteCollectionAction item={record} {...props} />;
};
...
const useDestroyActionForExternalDS = () => {
  ...
  return {
    async run() {
      console.log('[PostgresDeleteCollection] run() called', { collectionName, dataSourceKey, cascade });
      ...
      try {
        const url = `dataSources/${dataSourceKey}/collections:destroy`;
        console.log('[PostgresDeleteCollection] Making API request to:', url, { filterByTk: collectionName, cascade });
        ...
        console.log('[PostgresDeleteCollection] API request successful');
        message.success('Collection deleted successfully');
        refresh();
      } catch (error: any) {
        console.error('[PostgresDeleteCollection] API request failed:', error);
...
export const PostgresDeleteCollectionAction = (props: any) => {
...
PostgresDeleteCollectionAction.displayName = 'PostgresDeleteCollectionAction';
